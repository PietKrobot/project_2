...
function placeShellyOnDom() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let plugStatus = yield getShellyPlugInfo();
        ...
        if (plugs != undefined) {
            for (let i = 0; i < plugs.length; i++) {
                ...
                powerIcon.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    else if (plugs[i].state == false) {
                        myString1 = 'off';
                    }
                    yield setPlugState("0", plugs[i].ip, myString1);
                    if (plugs[i].state == true) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (plugs != undefined) {
            for (let i = 0; i < plugs.length; i++) {
                ...
                let powerInfo = document.getElementById("power" + plugs[i].id);
                powerInfo.textContent = power + "W";
            }
            console.log("Refreshed Power");
        }
        else {
            console.log("No refresches of power status ");
        }
    });
}
/*
...
function placeHueOnDom() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let lampInfo = yield getLampsInfo();
        ...
        for (let lampId in lampInfo) {
            ...
            powerIcon.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
                ...
                let result = yield setLightState(Number(dataLamp.id), newState);
                if (result) {
